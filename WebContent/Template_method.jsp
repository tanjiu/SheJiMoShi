...
<div class="top">
 ...
 <section class="conter">
        ...
        <a href="Code/模板方法模式.txt">基本</a>
        <a href="Code/试卷类.txt">试卷类</a>
        <a href="Code/数据库连接.txt">数据库连接</a>
        <a href="Code/系统登录类.txt">系统登录类</a>
<!--         <a href="Code/容错恢复机制.txt">容错恢复机制</a> -->
        </p>
        
       	<img alt="这是此模式的UML图" src="images/Template_method.png" width="800px" height="600px">
