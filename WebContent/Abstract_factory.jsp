...
<div class="top">
 ...
 <section class="conter">
        ...
        <a href="Code/配置文件.txt">配置文件</a>
        <a href="Code/数据库的转换1.txt">数据库1</a>
        <a href="Code/数据库的转换2.txt">数据库2</a>
        <a href="Code/数据库的转换3反射.txt">数据库3（反射）</a>
<!--         <a href="Code/容错恢复机制.txt">容错恢复机制</a> -->
        </p>
        
       	<img alt="这是此模式的UML图" src="images/Abstract_factory.png" width="800px" height="600px">
