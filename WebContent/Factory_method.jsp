...
<div class="top">
 ...
 <section class="conter">
        ...
        <a href="Code/工厂方法模式.txt">基本</a>
        <a href="Code/导出数据.txt">导出数据</a>
        <a href="Code/雷锋.txt">雷锋</a>
        <a href="Code/计算器2.txt">计算器2</a>
<!--         <a href="Code/容错恢复机制.txt">容错恢复机制</a> -->
        </p>
        
       	<img alt="这是此模式的UML图" src="images/Factory_method.png" width="800px" height="600px">
