...
<div class="top">
 ...
 <section class="conter">
        ...
        <a href="Code/享元模式.txt">基本</a>
        <a href="Code/网站1.txt">网站1</a>
        <a href="Code/网站2.txt">网站2</a>
        <a href="Code/网站3.txt">网站3</a>
<!--         <A HREF="CODE/容错恢复机制.TXT">容错恢复机制</A> -->
        </p>
        
       	<img alt="这是此模式的UML图" src="images/Flyweight.png" width="800px" height="600px">
